<?php 
$this->Html->addCrumb(__('Editar Banners'), ['controller' => 'Categorias', 'action' => 'add','plugin' => false]);
?>

<div class="panel">
  <div class="panel-heading">
    <span class="panel-title">
      <?php echo __('Editar Banners'); ?>
    </span>
      ...
      <div class="ca-form">
        ...
        <div class="col-md-6">
          <div class="um-form-row form-group">
            ...
            <div class="col-sm-10">
              <?php echo $this->Form->input('vigencia_inicio', ['type'=>'text', 'label'=>false, 'div'=>false, 'class'=>'form-control datepicker', 'value'=> ($banner->vigencia_inicio)? $banner->vigencia_inicio->format('d/m/Y') : '']); ?>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6">
          <div class="um-form-row form-group">
            ...
            <div class="col-sm-10">
              <?php echo $this->Form->input('vigencia_fin', ['type'=>'text', 'label'=>false, 'div'=>false, 'class'=>'form-control datepicker', 'value'=> ($banner->vigencia_fin)? $banner->vigencia_fin->format('d/m/Y') : '']); ?>
            </div>
          </div>
        </div>
