<?php 
    $this->Html->addCrumb(__('Editar Cupón'), ['controller' => 'Cupones', 'action' => 'add','plugin' => false]);
?>
    <?= $this->Form->create($cupone, ['class' => 'form-horizontal']) ?>
<div class="panel">
  <div class="panel-heading">
    <span class="panel-title">
      <?php echo __('Editar Cupón'); ?>
    </span>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <label class="custom-control custom-checkbox col-sm-3 control-label">
                                <input type="checkbox" name="cu" data-validation="required" id="cupon-unico">
                              <span class="custom-control-indicator"></span>
                              <input type="hidden" id="cupon-unico-hidden" name="cupon_unico">
...
<script type="text/javascript">
    ...
    $('#cupon-unico').change(function(){
            if($(this).prop('checked')){
                $('#cupon-unico-hidden').val('1'); 
            }else{
                $('#cupon-unico-hidden').val('0'); 
            }
        });
    $(document).ready(function(){
        var flag = '<?php echo $cupone->cupon_unico;?>';
        if(flag ==1){
            $('#cupon-unico').prop("checked", true);
        }else{
            $('#cupon-unico').prop("checked", false);
        }
        console.log(flag);
